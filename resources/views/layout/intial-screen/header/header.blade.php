<head>
    ...
    <!-- Gymify Master Branding Favicon -->
    ...
    <!-- Gymify Master Meta Tags -->
    <title>@yield('title', 'Gymify - Multi-Tenant Gym Management Platform')</title>
    <meta name="description" content="@yield('meta_description', 'Gymify is a comprehensive multi-tenant gym management platform. Choose from our network of premium fitness facilities and find the perfect gym for your fitness journey with state-of-the-art equipment and expert trainers.')">
    <meta name="keywords" content="@yield('meta_keywords', 'gymify, gym management, fitness platform, multi-tenant, gym software, fitness facilities, workout, exercise, health, wellness, training')">
    ...
    <meta property="og:title" content="@yield('og_title', 'Gymify - Multi-Tenant Gym Management Platform')">
    ...
    <meta property="og:site_name" content="Gymify">
    <meta property="og:locale" content="en_US">
    
    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:url" content="{{ request()->url() }}">
    <meta name="twitter:title" content="@yield('twitter_title', 'Gymify - Multi-Tenant Gym Management Platform')">
    ...
    <meta name="apple-mobile-web-app-title" content="Gymify">
    <meta name="application-name" content="Gymify">
    ...
    <script type="application/ld+json">
    {
        ...
        "sameAs": [
            "https://www.facebook.com/gymify",
            "https://www.twitter.com/gymify",
            "https://www.instagram.com/gymify"
        ],
        "contactPoint": {
            "@type": "ContactPoint",
