...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Edit Staff Member: {{ $staff->name }}</h3>
    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        @error('image')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <div class="form-text">Accepted formats: JPG, PNG, GIF. Max size: 2MB. Leave empty to keep current image.</div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input @error('role_ids') is-invalid @enderror" type="checkbox" 
                                           ...
                                           {{ in_array($role['id'], old('role_ids', $staff->roles->pluck('id')->toArray())) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input @error('branch_ids') is-invalid @enderror" type="checkbox" 
                                           ...
                                           {{ in_array($branch['id'], old('branch_ids', $staff->assignedBranches->pluck('id')->toArray())) ? 'checked' : '' }}>
