    ...
    <div class="col-xl-8">
        <div class="card card-flush h-xl-100">
            ...
            <div class="card-body pt-2">
                ...
                <!-- Trainer Photos -->
                @if($trainer->photos->count() > 0)
                <div class="mb-8">
                    <h4 class="fs-5 fw-bold text-gray-800 mb-3">Trainer Photos</h4>
                    <div class="row g-3">
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">{{ $photo->title ?: 'Trainer Photo' }}</h5>
                    ...
                    <div class="text-center mt-3">
                        <button class="btn btn-sm btn-light-primary" type="button" data-bs-toggle="collapse" data-bs-target="#allPhotos" aria-expanded="false">
                            View All Photos ({{ $trainer->photos->count() }})
                        </button>
                    </div>
                    
                    <div class="collapse mt-3" id="allPhotos">
                        <div class="row g-3">
                            @foreach($trainer->photos->skip(8) as $photo)
                            <div class="col-md-3 col-sm-4 col-6">
                                <div class="card card-flush h-100">
                                    <div class="card-body p-2">
                                        <div class="position-relative">
