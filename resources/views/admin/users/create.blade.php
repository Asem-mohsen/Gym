            ...
            <div class="row gx-4">
                ...
                <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                    ...
                    <ul class="nav nav-pills nav-fill p-1" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link mb-0 px-0 py-1 d-flex align-items-center justify-content-center " href="{{route('users.index')}}" data-bs-toggle="tab"  role="tab" aria-selected="false">
                                <i class="ni ni-app"></i>
                                <span class="ms-2">All Users</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link mb-0 px-0 py-1 d-flex align-items-center justify-content-center " href="{{route('users.show' , auth()->user()->id)}}" data-bs-toggle="tab"  role="tab" aria-selected="false">
