    ...
    {{-- <section class="col-lg-7 connectedSortable">
        ...
        <div class="card-body">
            ...
            <ul class="contacts-list">
                ...
                <li>
                <a href="#">
                    <img class="contacts-list-img" src="{{asset('assets/dist/img/user2-160x160.jpg')}}" alt="User Avatar">
                ...
                <li>
                <a href="#">
                    <img class="contacts-list-img" src="{{asset('assets/dist/img/user4-128x128.jpg')}}" alt="User Avatar">
