                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('neme') is-invalid @enderror" type="text"  name="name" value="{{$admin->name}}" required>
                                    </div>
                                    @error('name')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('email') is-invalid @enderror" type="email" name="email" value="{{$admin->email}}" required>
                                    </div>
                                    @error('email')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control @error('role_id') is-invalid @enderror" name="role_id" id="choices-button">
                                        @foreach ($roles as $role)
                                            <option @selected($role->id == $admin->role_id) value="{{ $role->id }}">{{ $role->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('role_id')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" name="gender" id="gender">
                                        <option value="male" @selected(isset($admin) && $admin->gender == 'male')>Male</option>
                                        <option value="female" @selected(isset($admin) && $admin->gender == 'female')>Female</option>
                                    </select>
                                    @error('gender')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="status" id="status_active" value="1" 
                                            @checked(isset($admin) && $admin->status == 1)>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="status" id="status_inactive" value="0"
                                            @checked(isset($admin) && $admin->status == 0)>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('address') is-invalid @enderror" name="address">{{$admin->address}}</textarea>
                                        @error('address')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('phone') is-invalid @enderror" type="text" name="phone" value="{{$admin->phone}}">
                                    </div>
                                    @error('phone')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
