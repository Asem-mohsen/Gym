            ...
            <div class="card">
                <div class="card-body row">
                    ...
                    <div class="mb-10 col-md-6">
                        ...
                        <input type="number" name="invitation_limit" id="invitation_limit" value="{{ old('invitation_limit', $membership->invitation_limit ?? 0) }}" class="form-control form-control-solid required" min="0" required/>
                    ...
                    <div class="mb-10 col-md-6">
                        ...
                        <textarea name="subtitle[en]" id="subtitle_en" class="form-control form-control-solid required" required>{{ $membership->getTranslation('subtitle','en') }}</textarea>
                    </div>
                    <div class="mb-10 col-md-6">
                        <label for="subtitle_ar" class="required form-label">Subtitle (Arabic)</label>
                        <textarea name="subtitle[ar]" id="subtitle_ar" class="form-control form-control-solid required" required>{{ $membership->getTranslation('subtitle','ar') }}</textarea>
                    </div>
                    <div class="mb-10 col-md-6">
                        <label for="description_en" class="required form-label">Description (English)</label>
                        <textarea name="general_description[en]" id="description_en" class="form-control form-control-solid required" required>{{ $membership->getTranslation('general_description','en') }}</textarea>
                    </div>
                    <div class="mb-10 col-md-6">
                        <label for="description_ar" class="required form-label">Description (Arabic)</label>
                        <textarea name="general_description[ar]" id="description_ar" class="form-control form-control-solid required" required>{{ $membership->getTranslation('general_description','ar') }}</textarea>
                    </div>
                </div>
