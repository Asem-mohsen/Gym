                            ...
                            <div class="col-lg-6">
                                <div class="comment-option">
                                    ...
                                    <div class="co-item">
                                        ...
                                        <div class="co-pic">
                                            <img src="{{ asset('assets/user/img/blog/details/comment-1.jpg')}}" alt="">
                                    ...
                                    <div class="co-item reply-comment">
                                        ...
                                        <div class="co-pic">
                                            <img src="{{ asset('assets/user/img/blog/details/comment-2.jpg')}}" alt="">
                                            <h5>Brandon Kelley</h5>
                                        </div>
                                        <div class="co-text">
                                            <p>Neque porro quisquam est, qui dolorem ipsum dolor sit amet, consectetur,
                                    ...
                                    <div class="co-item">
                                        ...
                                        <div class="co-pic">
                                            <img src="{{ asset('assets/user/img/blog/details/comment-3.jpg')}}" alt="">
                                            <h5>Brandon Kelley</h5>
                                        </div>
                                        <div class="co-text">
                                            <p>Neque porro quisquam est, qui dolorem ipsum dolor sit amet, consectetur,
